...
public class MyDemoLoggingAspect {
	...
	@Around("execution(* com.luv2code.aop.service.*.getFortune(..))")
	public Object aroundGetFortune(ProceedingJoinPoint theProceedingJoinPoint)
	throws Throwable
	{
		// print out the methods we are advising on
	...
	@After("execution(* com.luv2code.aop.dao.AccountDAO.findAccounts(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.luv2code.aop.dao.AccountDAO.findAccounts(..))", throwing = "theExe")
	...
	@AfterReturning(pointcut = "execution(* com.luv2code.aop.dao.AccountDAO.findAccounts(..))", returning = "result")
